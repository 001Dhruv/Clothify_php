<?php
      $query="select * from product where p_gender='Women';";
      $servername = "localhost";
      $username = "root";
      $password = "123456";
      $conn = new mysqli($servername, $username, $password,"clothify_php");
      $result=mysqli_query($conn,$query);?><h2 style="text-decoration:underline; text-align:center; margin-top:20px;">Women's Wear</h2><?php
